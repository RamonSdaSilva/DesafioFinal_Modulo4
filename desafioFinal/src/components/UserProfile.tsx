...
const UserProfile: React.FC = () => {
  ...
  return (
    <div className="bg-gray-100 h-screen flex flex-col overflow-y-hidden">
      ...
      <div className="flex-grow overflow-y-hidden p-4">
        <h1 className="text-3xl mb-4 ml-2 font-semibold text-gray-800">Informaçãoes do perfil</h1>
        {userData && (
          <div className="bg-white rounded-lg p-4 shadow-md mb-6 ml-8" style={{ maxWidth: '40%' }}>
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <img src={userData.avatar_url} alt="Avatar do usuário" className="w-20 h-20 rounded-full" />
              </div>
              <div className="ml-4">
          ...
          <div className="w-full">
            ...
            <div className="flex flex-wrap justify-center">
              {paginatedRepos.map((repo, index) => (
                <div
                  key={index}
                  className="w-96 h-64 p-4 mb-8 mx-4 border border-gray-300 shadow-md cursor-pointer"
                ...
                >
                  ...
                  <p className="text-black mb-2">Link do git hub:</p>
                  <a
                    href={repo.html_url}
                    target="_blank"
                    rel=""
